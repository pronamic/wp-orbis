...
<div>
	<h2><?php esc_html_e( 'Recent Posts', 'orbis' ); ?></h2>

	<?php

	$query = new WP_Query( wp_parse_args( array( 'post_type' => 'post' ), $defaults ) );
...
<div>
	<h2><?php esc_html_e( 'Recent Keychains', 'orbis' ); ?></h2>

	<?php

	$query = new WP_Query( wp_parse_args( array( 'post_type' => 'orbis_keychain' ), $defaults ) );
