...
class Orbis_Plugin_Manager {
	...
	public function install_plugin( $plugin_slug ) {
		...
		if ( is_wp_error( $skin->error ) ) {
			return new WP_Error( 2, $skin->error->get_error_message() );
		}
	...
	public static function is_plugin_installed( $plugin_slug, $plugin_file_name = null ) {
		...
		if ( isset( self::$recommended_plugins[ $plugin_slug ] ) && strlen( self::$recommended_plugins[ $plugin_slug ]['file_name'] ) > 0 ) {
